...
class HolidaysControllerTest < ActionController::TestCase
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post :create, holiday: { end_date: @holiday.end_date, end_time: @holiday.end_time, start_date: @holiday.start_date, start_time: @holiday.start_time }
    end
  ...
  test "should update holiday" do
    patch :update, id: @holiday, holiday: { end_date: @holiday.end_date, end_time: @holiday.end_time, start_date: @holiday.start_date, start_time: @holiday.start_time }
    assert_redirected_to holiday_path(assigns(:holiday))
  end
