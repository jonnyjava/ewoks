...
describe ServicesController do
  describe "routing" do
    ...
    it { expect(get: "/services/1/edit").to_not route_to("services#edit", id: "1") }
    it { expect(post: "/services").to_not route_to("services#create") }
    it { expect(put: "/services/1").to_not route_to("services#update", id: "1") }
    it { expect(patch: "/services/1").to_not route_to("services#update", id: "1") }
